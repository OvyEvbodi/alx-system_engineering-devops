...
""" Get the num from the cl, get all todos with that user_id,
get the user with that id,
if task completed, append to the list, else, just count
completed tasks is list len, total is count
"""
def getTodos():
    ...
    if len(argv) > 1:
        ...
        completed_tasks = [task for task in response_todo if task.get("completed") == True]
